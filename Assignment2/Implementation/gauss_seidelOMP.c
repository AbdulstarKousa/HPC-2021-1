...
gauss_seidelOMP:
Purpose:
    solves parallelly, using OMP, the given discretized problem (Poisson problem in 3d) using 3D Gauss-Seidel alg.
Return value:
    the Frobenius norm when the diference is suciently small. 
*/
double gauss_seidelOMP( double*** f,      /* 3D matrix "Cube" of function values, Second derivatives of temperature  */
