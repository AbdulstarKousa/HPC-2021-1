...
__global__ 
void jacobi_kernel31(double*** d0_f,double*** d0_u,double*** d1_u, double *** d0_u_next,int N,double d_squared,double inv);
void jacobi_kernel32(double*** d1_f,double*** d1_u,double*** d0_u,double *** d1_u_next,int N,double d_squared,double inv);
