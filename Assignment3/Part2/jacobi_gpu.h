...
__global__ 
void jacobi_kernel31(double*** d_f,double*** d_u,double *** d_u_next,int N,double d_squared,double inv);
void jacobi_kernel32(double*** d_f,double*** d_u,double *** d_u_next,int N,double d_squared,double inv);
