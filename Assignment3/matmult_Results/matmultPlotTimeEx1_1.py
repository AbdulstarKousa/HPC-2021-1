...
plt.plot(data["Problem Size[elm]"], data["Kernel wall time[s]"] + data["Memory wall time[s]"], label = "gpu1 wall time", linestyle="--")
plt.plot(data["Problem Size[elm]"], data["Memory wall time[s]"], label = "gpu1 memory time", linestyle="--")
plt.legend()
